...
way away from the shape I once was.
...
year, I do not think I have really dared to run _fast_ fast.

Back in January of this year, I had another patella tendon setback. Coming back
...
I made the track my place to go mid week: Repetition (around 1500m race pace),
...
{% include image.html domain=site.baseurl url='/assets/img/20251107-prtc5000/0.avif' description='As we are yelled into action. I am the white shirt behind the two women on the right.' %}
...
he was doing a great job, pacing us like clockwork.
...
{% include image.html domain=site.baseurl url='/assets/img/20251107-prtc5000/1800.avif' description='Just chilling in lockstep behind the pacer.' %}
...
matter much to me. I was here to see my time, not to place.
...
behind the pacer, letting him keep it at a nice just below 18 min pace.
...
and after 200 metre the pain subsided.
...
OK. I pushed to the line without cracking.

{% include image.html domain=site.baseurl url='/assets/img/20251107-prtc5000/4950.avif' description='Grimacing at the suffering in the final push down the home straight.' %}
...
might decide on a race on a whim, but I do not dare to plan for one.

[strava]: https://www.strava.com/activities/16388622737
